...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(12)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, shared_1) {
    ...
    var H5GoogleAdHandler = /** @class */ (function () {
        ...
        H5GoogleAdHandler.prototype.startCooldown = function () {
            var _this = this;
        ...
        H5GoogleAdHandler.prototype.showAd = function (adType) {
            if (adType === void 0) { adType = shared_1.AdType.interstitial; }
            if ((!this.adsEnabled || this.isCooldownRunning) && adType === shared_1.AdType.interstitial) {
            ...
            try {
                ...
                window.adBreak({
                    ...
                    afterAd: function () {
                        _this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED);
                        _this.startCooldown();
                    } // You may also want to unmute the game's sound.
                });
            }
            catch (error) {
        ...
        H5GoogleAdHandler.prototype.showRewardedAd = function (config) {
            ...
            this.startAdTimeout(shared_1.AdType.rewarded);
            try {
        ...
        H5GoogleAdHandler.prototype.adAvailable = function (adType) {
            return (adType === shared_1.AdType.rewarded && this.showRewardedAdFN !== null);
        };
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(444), __webpack_require__(730), __webpack_require__(363)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, shared_1, GameDistributionBanner_1, AdTimerManager_1, UpdatedBannerFactory_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(34), __webpack_require__(12), __webpack_require__(563), __webpack_require__(766)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, eventemitter3_1, shared_1, standard_1, special_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
/* uglified */
(()=>{var o={729:e=>{"use strict";var o=Object.prototype.hasOwnProperty,f="~";function n(){}function a(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function r(e,t,n,o,r){if("function"!=typeof n)throw new TypeError("The listener must be a function");n=new a(n,o||e,r),o=f?f+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],n]:e._events[o].push(n):(e._events[o]=n,e._eventsCount++),e}function d(e,t){0==--e._eventsCount?e._events=new n:delete e._events[t]}function t(){this._events=new n,this._eventsCount=0}Object.create&&(n.prototype=Object.create(null),(new n).__proto__||(f=!1)),t.prototype.eventNames=function(){var e,t,n=[];if(0===this._eventsCount)return n;for(t in e=this._events)o.call(e,t)&&n.push(f?t.slice(1):t);return Object.getOwnPropertySymbols?n.concat(Object.getOwnPropertySymbols(e)):n},t.prototype.listeners=function(e){var e=f?f+e:e,t=this._events[e];if(!t)return[];if(t.fn)return[t.fn];for(var n=0,o=t.length,r=new Array(o);n<o;n++)r[n]=t[n].fn;return r},t.prototype.listenerCount=function(e){e=f?f+e:e,e=this._events[e];return e?e.fn?1:e.length:0},t.prototype.emit=function(e,t,n,o,r,a){var i=f?f+e:e;if(!this._events[i])return!1;var s,d=this._events[i],l=arguments.length;if(d.fn){switch(d.once&&this.removeListener(e,d.fn,void 0,!0),l){case 1:return d.fn.call(d.context),!0;case 2:return d.fn.call(d.context,t),!0;case 3:return d.fn.call(d.context,t,n),!0;case 4:return d.fn.call(d.context,t,n,o),!0;case 5:return d.fn.call(d.context,t,n,o,r),!0;case 6:return d.fn.call(d.context,t,n,o,r,a),!0}for(p=1,s=new Array(l-1);p<l;p++)s[p-1]=arguments[p];d.fn.apply(d.context,s)}else for(var u,c=d.length,p=0;p<c;p++)switch(d[p].once&&this.removeListener(e,d[p].fn,void 0,!0),l){case 1:d[p].fn.call(d[p].context);break;case 2:d[p].fn.call(d[p].context,t);break;case 3:d[p].fn.call(d[p].context,t,n);break;case 4:d[p].fn.call(d[p].context,t,n,o);break;default:if(!s)for(u=1,s=new Array(l-1);u<l;u++)s[u-1]=arguments[u];d[p].fn.apply(d[p].context,s)}return!0},t.prototype.on=function(e,t,n){return r(this,e,t,n,!1)},t.prototype.once=function(e,t,n){return r(this,e,t,n,!0)},t.prototype.removeListener=function(e,t,n,o){e=f?f+e:e;if(this._events[e])if(t){var r=this._events[e];if(r.fn)r.fn!==t||o&&!r.once||n&&r.context!==n||d(this,e);else{for(var a=0,i=[],s=r.length;a<s;a++)(r[a].fn!==t||o&&!r[a].once||n&&r[a].context!==n)&&i.push(r[a]);i.length?this._events[e]=1===i.length?i[0]:i:d(this,e)}}else d(this,e);return this},t.prototype.removeAllListeners=function(e){return e?(e=f?f+e:e,this._events[e]&&d(this,e)):(this._events=new n,this._eventsCount=0),this},t.prototype.off=t.prototype.removeListener,t.prototype.addListener=t.prototype.on,t.prefixed=f,e.exports=t.EventEmitter=t},524:function(e,t,n){var y=this&&this.__assign||function(){return(y=Object.assign||function(e){for(var t,n=1,o=arguments.length;n<o;n++)for(var r in t=arguments[n])Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r]);return e}).apply(this,arguments)},g=this&&this.__awaiter||function(e,i,s,d){return new(s=s||Promise)(function(n,t){function o(e){try{a(d.next(e))}catch(e){t(e)}}function r(e){try{a(d.throw(e))}catch(e){t(e)}}function a(e){var t;e.done?n(e.value):((t=e.value)instanceof s?t:new s(function(e){e(t)})).then(o,r)}a((d=d.apply(e,i||[])).next())})},m=this&&this.__generator||function(o,r){var a,i,s,d={label:0,sent:function(){if(1&s[0])throw s[1];return s[1]},trys:[],ops:[]},l={next:e(0),throw:e(1),return:e(2)};return"function"==typeof Symbol&&(l[Symbol.iterator]=function(){return this}),l;function e(n){return function(e){var t=[n,e];if(a)throw new TypeError("Generator is already executing.");for(;d=l&&t[l=0]?0:d;)try{if(a=1,i&&(s=2&t[0]?i.return:t[0]?i.throw||((s=i.return)&&s.call(i),0):i.next)&&!(s=s.call(i,t[1])).done)return s;switch(i=0,(t=s?[2&t[0],s.value]:t)[0]){case 0:case 1:s=t;break;case 4:return d.label++,{value:t[1],done:!1};case 5:d.label++,i=t[1],t=[0];continue;case 7:t=d.ops.pop(),d.trys.pop();continue;default:if(!(s=0<(s=d.trys).length&&s[s.length-1])&&(6===t[0]||2===t[0])){d=0;continue}if(3===t[0]&&(!s||t[1]>s[0]&&t[1]<s[3]))d.label=t[1];else if(6===t[0]&&d.label<s[1])d.label=s[1],s=t;else{if(!(s&&d.label<s[2])){s[2]&&d.ops.pop(),d.trys.pop();continue}d.label=s[2],d.ops.push(t)}}t=r.call(o,d)}catch(e){t=[6,e],i=0}finally{a=s=0}if(5&t[0])throw t[1];return{value:t[0]?t[1]:void 0,done:!0}}}},n=[n,t,n(790),n(644),n(49),n(909),n(347),n(130),n(594),n(243),n(393),n(812),n(800)],t=function(e,t,n,o,r,a,i,s,d,l,u,c,p){"use strict";var f,h;function v(){}Object.defineProperty(t,"__esModule",{value:!0}),t.AzerionIntegrationSDK=t.AnalyticsEventTypes=void 0,(h=f=t.AnalyticsEventTypes||(t.AnalyticsEventTypes={})).Google="gg",h.Game="gme",h.Standard="std",h.OrangeTag="orangetag",h.None="none",v.init=function(e){e=y(y({},v.config),e);p.Utils.setAssetPath(),d.JioIntegration.init(e.adProvider),v.config=e,(v.ads=new n.AdHandler).init(e.adProvider,e.gameId,Boolean(e.enableAdTimer),Boolean(e.enableBanner)),(v.gmo=new s.GMOIntegration).init(e.extSdk),(v.aeria=new i.AeriaIntegration).init(),v.orange=new a.OrangeTagEventHandler,v.gameEventHandler=new r.GameEventHandler,v.funMaxEventHandler=new o.FunMaxEventHandler,(v.youtubePlayable=new l.YoutubePlayable).init()},v.onLoadStart=function(n){return g(this,void 0,void 0,function(){return m(this,function(e){return[2,new Promise(function(e,t){v.config.splashEnabled?(v.aeria.onGameLoad(n),u.AzerionSplashLoader.create(v.config.gameId,v.config.gameTitle).then(e).catch(t)):(v.aeria.onGameLoad(n),e(!0)),v.funMaxEventHandler.loadStart()})]})})},v.onLoadProgress=function(e){v.config.splashEnabled&&u.AzerionSplashLoader.onLoadProgress(e)},v.onSplashRemoved=function(){this.youtubePlayable.onSplashRemoved()},v.onLoadComplete=function(){return g(this,void 0,void 0,function(){return m(this,function(e){switch(e.label){case 0:return v.config.splashEnabled?[4,u.AzerionSplashLoader.onLoadComplete()]:[3,2];case 1:e.sent(),e.label=2;case 2:return v.funMaxEventHandler.loadReady(),[2,v.config.splashEnabled?u.AzerionSplashLoader.removeSplashLoader():Promise.resolve(!0)]}})})},v.addListeners=function(e,t,n,o){v.ads.addListeners(function(){e(),n()},function(){t(),o()}),v.youtubePlayable.addListeners(e,t,n,o)},v.onAdProviderLoaded=function(){return g(this,void 0,void 0,function(){return m(this,function(e){return[2,v.ads.onAdProviderLoaded()]})})},v.onGameStart=function(t){return g(this,void 0,void 0,function(){return m(this,function(e){return"gmo"===v.config.extSdk?[2,v.gmo.onGameStart()]:(v.config.alxType===f.OrangeTag&&v.orange.sendLevelStart(),t?v.gameEventHandler.trackLevelStart(t):console.warn("AzerionIntegrationSDK.onGameStart called without payload. Skipping tracking."),[2,Promise.resolve(!0)])})})},v.onGameEnd=function(n){return g(this,void 0,void 0,function(){var t;return m(this,function(e){return t=(null==n?void 0:n.score)||0,"gmo"===v.config.extSdk?[2,v.gmo.onGameEnd(t)]:(v.config.alxType===f.OrangeTag&&v.orange.sendLevelEnd(),n?v.gameEventHandler.trackLevelComplete(n):console.warn("AzerionIntegrationSDK.onGameEnd called without payload. Skipping tracking."),[2,Promise.resolve(!0)])})})},v.showInterstitialAd=function(){return g(this,void 0,void 0,function(){return m(this,function(e){return[2,v.ads.showInterstitialAd()]})})},v.showRewardedAd=function(){return g(this,void 0,void 0,function(){return m(this,function(e){return"gmo"===v.config.extSdk?[2,v.gmo.showRewardedAd()]:[2,v.ads.showRewardedAd()]})})},v.rewardedAdAvailable=function(){return v.ads.rewardedAdAvailable()},v.preloadAd=function(e){v.ads.preloadAd(e)},v.isAdPlaying=function(){return v.ads.isAdPlaying()},v.setData=function(t){return g(this,void 0,void 0,function(){return m(this,function(e){return"gmo"===v.config.extSdk?[2,v.gmo.setData(t)]:"ytplayable"===v.config.extSdk||window.hasOwnProperty("ytgame")?[2,v.youtubePlayable.setData(t)]:[2,c.StorageHandler.setData(t)]})})},v.getData=function(t){return g(this,void 0,void 0,function(){return m(this,function(e){return"gmo"===v.config.extSdk?[2,v.gmo.getData()]:"ytplayable"===v.config.extSdk||window.hasOwnProperty("ytgame")?[2,v.youtubePlayable.getData()]:[2,c.StorageHandler.getData(t)]})})},v.sendScoreEvent=function(t){return g(this,void 0,void 0,function(){return m(this,function(e){return v.aeria.isAeriaIntegration()&&v.aeria.sendScoreEvent(t.platformId,t.score),v.youtubePlayable.inPlayablesEnv()?[2,v.youtubePlayable.sendScoreEvent(t.score)]:(window.gdsdk&&v.gameEventHandler.trackScoreUpdate(t),[2,Promise.resolve(!0)])})})},v.isAdProviderLoaded=function(){return v.ads.isAdProviderLoaded()},v.registerStoreUIVisibilityChangeListener=function(e){v.ads.registerStoreUIVisibilityChangeListener(e)},v.pauseAdTimer=function(){v.ads.pauseAdTimer()},v.resumeAdTimer=function(){v.ads.resumeAdTimer()},v.createBanner=function(e){v.ads.createBanner(e)},v.destroyBanner=function(e,t){v.ads.destroyBanner(e,t)},v.resizeBanner=function(){v.ads.resizeBanner()},v.hasPlatformLanguage=function(){try{if("ytplayable"===v.config.extSdk||window.hasOwnProperty("ytgame"))return v.youtubePlayable.inPlayablesEnv()}catch(e){console.error("Error in hasPlatformLanguage:",e)}return!1},v.getPlatformLanguage=function(){return v.youtubePlayable.inPlayablesEnv()?v.youtubePlayable.getLanguage():null},v.hasPlatformAudioControl=function(){return!!v.youtubePlayable.inPlayablesEnv()},v.getPlatformAudioStatus=function(){return!!v.youtubePlayable.inPlayablesEnv()&&v.youtubePlayable.enableAudioOnStart()},v.config={enableAdTimer:!1,enableBanner:!1,splashEnabled:!1,gmoEnabled:!1,extSdk:void 0,alxType:f.None,adProvider:"gd",gameId:void 0},t.AzerionIntegrationSDK=v}.apply(t,n);void 0!==t&&(e.exports=t)},790:(e,t,n)=>{n=[n,t,n(377)],t=function(e,t,r){"use strict";var a,n;function o(){this.gdStoreVisible=!1,this.adCancelled=!1,this.adSkipped=!1}Object.defineProperty(t,"__esModule",{value:!0}),t.AdHandler=t.AdEventType=void 0,a={PAUSED:"Paused",RESUMED:"Resumed"},(n=t.AdEventType||(t.AdEventType={})).REWARDED="rewarded",n.INTERSTITIAL="interstitial",o.prototype.init=function(e,t,n,o){this.azAdWrapper=new window.h5ads.AdWrapper(e,t,n,o),this.contentStatus=a.RESUMED},o.prototype.addListeners=function(e,t){var n=this;this.azAdWrapper.on(h5ads.AdEvents.CONTENT_PAUSED,function(){console.log("CONTENT_PAUSED"),n.contentStatus=a.PAUSED,e&&e()}),this.azAdWrapper.on(h5ads.AdEvents.CONTENT_RESUMED,function(){console.log("CONTENT_RESUMED"),r.LoaderHelper.hide(),n.contentStatus=a.RESUMED,t&&t(),window.focus()}),this.azAdWrapper.on(h5ads.AdEvents.AD_SDK_CANCELED,function(){console.log("AD_SDK_CANCELED"),n.adCancelled=!0}),this.azAdWrapper.on(h5ads.AdEvents.AD_SKIPPED,function(){console.log("AD_SKIPPED"),n.adSkipped=!0})},o.prototype.registerStoreUIVisibilityChangeListener=function(e){var t=this;this.azAdWrapper.on(h5ads.AdEvents.STORE_UI_VISIBILITY_CHANGED,function(){console.log("DEBUG: STORE_UI_VISIBILITY_CHANGED"),t.gdStoreVisible=t.azAdWrapper.isStoreUIVisible(),e&&e(t.gdStoreVisible)})},o.prototype.onAdProviderLoaded=function(){var n=this;return new Promise(function(t,e){n.azAdWrapper.on(h5ads.AdEvents.AD_PROVIDER_LOADED,function e(){console.log("DEBUG: onAdProviderLoaded"),t(!0),n.azAdWrapper.removeListener(h5ads.AdEvents.AD_PROVIDER_LOADED,e)})})},o.prototype.showInterstitialAd=function(){var n=this;return r.LoaderHelper.show(),new Promise(function(t,e){n.azAdWrapper.on(h5ads.AdEvents.CONTENT_RESUMED,function e(){console.log("DEBUG: onAdComplete"),r.LoaderHelper.hide(),t(),n.azAdWrapper.removeListener(h5ads.AdEvents.CONTENT_RESUMED,e)}),n.azAdWrapper.showAd(h5ads.AdType.interstitial)})},o.prototype.showRewardedAd=function(){var o=this;return r.LoaderHelper.show(),this.adCancelled=!1,this.adSkipped=!1,new Promise(function(t,e){var n=!1;o.azAdWrapper.addListener(h5ads.AdEvents.AD_REWARDED,function(){n=!0}),o.azAdWrapper.on(h5ads.AdEvents.CONTENT_RESUMED,function e(){console.log("DEBUG: onAdSuccess: rewarded"),r.LoaderHelper.hide(),o.azAdWrapper.removeListener(h5ads.AdEvents.CONTENT_RESUMED,e),o.azAdWrapper.removeAllListeners(h5ads.AdEvents.AD_REWARDED),t({rewarded:n,adCancelled:o.adCancelled,adSkipped:o.adSkipped})}),o.azAdWrapper.showAd(h5ads.AdType.rewarded)})},o.prototype.isAdPlaying=function(){return this.contentStatus===a.PAUSED},o.prototype.preloadAd=function(e){e=e===n.REWARDED?h5ads.AdType.rewarded:h5ads.AdType.interstitial;this.azAdWrapper.preloadAd(e)},o.prototype.rewardedAdAvailable=function(){return this.azAdWrapper.adAvailable(h5ads.AdType.rewarded)},o.prototype.isAdProviderLoaded=function(){return this.azAdWrapper.isLoadComplete()},o.prototype.pauseAdTimer=function(){try{this.azAdWrapper.pauseAdTimer()}catch(e){console.log("Could not pause timer")}},o.prototype.resumeAdTimer=function(){try{this.azAdWrapper.resumeAdTimer()}catch(e){console.log("Could not resume timer")}},o.prototype.createBanner=function(e){try{this.azAdWrapper.createBanner(e)}catch(e){console.log("Could not create banner")}},o.prototype.destroyBanner=function(e,t){try{this.azAdWrapper.destroyBanner(e,t)}catch(e){console.log("Could not destroy banner")}},o.prototype.resizeBanner=function(){try{this.azAdWrapper.resizeBanner()}catch(e){console.log("Could not resize banner")}},t.AdHandler=o}.apply(t,n);void 0!==t&&(e.exports=t)},644:(e,t,n)=>{n=function(e,t){"use strict";function n(){}Object.defineProperty(t,"__esModule",{value:!0}),t.FunMaxEventHandler=void 0,n.prototype.loadStart=function(){try{window.hasOwnProperty("funmax")&&window.funmax.loadStart()}catch(e){console.error("Error loading Funmax")}},n.prototype.loadReady=function(){try{window.hasOwnProperty("funmax")&&window.funmax.loadReady()}catch(e){console.error("Error loading Funmax")}},t.FunMaxEventHandler=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},49:function(e,t,n){var r=this&&this.__assign||function(){return(r=Object.assign||function(e){for(var t,n=1,o=arguments.length;n<o;n++)for(var r in t=arguments[n])Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r]);return e}).apply(this,arguments)},n=function(e,t){"use strict";var n;function o(){this.levelStartTimeStamp=0}Object.defineProperty(t,"__esModule",{value:!0}),t.GameEventHandler=t.GameEvents=void 0,(n=t.GameEvents||(t.GameEvents={})).LEVEL_START="levelStart",n.LEVEL_COMPLETE="levelComplete",n.LEVEL_FAIL="levelFail",o.prototype.sendEvent=function(e){var t=window.gdsdk;if(t&&"function"==typeof t.sendEvent)try{console.log("AzerionEventTracker sendEvent",e),h5branding.Hosts.isHighscoreAllowed()&&t.sendEvent(e)}catch(e){console.error("AzerionEventTracker send error",e)}},o.prototype.trackLevelStart=function(e){this.levelStartTimeStamp=Date.now();e=r(r({},e),{timestamp:this.levelStartTimeStamp});this.sendEvent({eventName:"game_event",data:e})},o.prototype.trackLevelComplete=function(e){var t=Date.now(),n=this.levelStartTimeStamp?Math.round((t-this.levelStartTimeStamp)/1e3):void 0,e=r(r({},e),{timestamp:t,timePlayed:n});this.levelStartTimeStamp=0,this.sendEvent({eventName:"game_event",data:e})},o.prototype.trackScoreUpdate=function(e){var t=(e.gameTitle||"").split(" ").join("_").toLowerCase(),t={level:e.level,event:"".concat(t,"_high_score"),cummulativeScore:e.cummulativeScore,score:e.score,scoreFormat:e.scoreFormat};this.sendEvent({eventName:"game_event",data:t})},t.GameEventHandler=o}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},909:(e,t,n)=>{n=[n,t,n(800)],t=function(e,t,n){"use strict";function o(){}Object.defineProperty(t,"__esModule",{value:!0}),t.OrangeTagEventHandler=void 0,o.prototype.sendLevelStart=function(){try{window.hasOwnProperty("dataLayer")&&window.dataLayer.push({event:"levelStart",publisher:"CONNECT2MEDIA",productKey:n.Utils.convertToCamelCase(window._azerionIntegration.gameTitle)})}catch(e){console.log("Could not send orange tag analytics event")}},o.prototype.sendLevelEnd=function(){try{window.hasOwnProperty("dataLayer")&&window.dataLayer.push({event:"levelCompletion",publisher:"CONNECT2MEDIA",productKey:n.Utils.convertToCamelCase(window._azerionIntegration.gameTitle)})}catch(e){console.log("Could not send orange tag analytics event")}},t.OrangeTagEventHandler=o}.apply(t,n);void 0!==t&&(e.exports=t)},377:(e,t,n)=>{n=function(e,t){"use strict";function n(){}Object.defineProperty(t,"__esModule",{value:!0}),t.LoaderHelper=void 0,n.show=function(){var e=document.getElementById("loader");e&&(e.style.display="block")},n.hide=function(){var e=document.getElementById("loader");e&&(e.style.display="none")},t.LoaderHelper=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},180:(e,t,n)=>{n=[n,t,n(524)],t=function(e,t,n){"use strict";window._azerionIntegrationSDK=n.AzerionIntegrationSDK}.apply(t,n);void 0!==t&&(e.exports=t)},347:(e,t,n)=>{n=function(e,t){"use strict";function n(){this.initialized=!1}Object.defineProperty(t,"__esModule",{value:!0}),t.AeriaIntegration=void 0,n.prototype.init=function(){this.initialized=h5branding.Hosts.isAeria()},n.prototype.onGameLoad=function(e){this.initialized&&h5branding.AeriaIntegration.onGameLoad(function(){e&&e()})},n.prototype.sendScoreEvent=function(n,o){return this.initialized?new Promise(function(e,t){h5branding.AeriaIntegration.sendScoreEvent(n,o,function(){e(!0)})}):Promise.resolve(!0)},n.prototype.isAeriaIntegration=function(){return this.initialized},t.AeriaIntegration=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},130:(e,t,n)=>{n=function(e,t){"use strict";function n(){this.initialized=!1}Object.defineProperty(t,"__esModule",{value:!0}),t.GMOIntegration=void 0,n.prototype.init=function(e){this.initialized=e&&"gmo"==e;e=this.initialized?"gmo":"gd";window._azIntGmo.EventHandler.init(e)},n.prototype.updateSplashLoader=function(){try{document.getElementById("h5branding-button").innerText="プレー"}catch(e){console.log("Could not change play text")}},n.prototype.triggerGMOEvent=function(e,t,n,o,r){try{var a=o&&JSON.stringify(o);window._azIntGmo.EventHandler.trigger(e,t,n,a,r)}catch(e){t()}},n.prototype.getData=function(){var t=this;return new Promise(function(n,e){t.triggerGMOEvent("game_get_data",function(e){var t={};try{t=JSON.parse(e.gamedata||"{}")}catch(e){console.log("Could not restore server saved data",e)}n(t)})})},n.prototype.setData=function(e){var n=this,o=e.score,r=e.data;return new Promise(function(e,t){n.triggerGMOEvent("game_save",function(){e(!0)},o,r)})},n.prototype.onGameEnd=function(n){var o=this;return new Promise(function(e,t){o.triggerGMOEvent("game_end",function(){e(!0)},n)})},n.prototype.onGameStart=function(){var n=this;return new Promise(function(e,t){n.triggerGMOEvent("game_start",function(){e(!0)})})},n.prototype.showRewardedAd=function(){var n=this;return new Promise(function(e,t){n.triggerGMOEvent("show_reward_ad",function(){e({rewarded:!0})},null,null,function(){e({rewarded:!1})})})},t.GMOIntegration=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},594:(e,t,n)=>{n=function(e,t){"use strict";function n(){}Object.defineProperty(t,"__esModule",{value:!0}),t.JioIntegration=void 0,n.init=function(e){var t=this;this.initialized="jio"===e&&!!window._azerionJGSDK,this.initialized&&(this.sdk=window._azerionJGSDK.JioGamesSP,this.sdk.getUserProfile(),setTimeout(function(){t.soundEnabled=t.sdk.isSoundEnable()},2e3))},n.isEnabled=function(){return this.initialized},n.postScore=function(e){this.initialized&&this.sdk.postScore(e)},n.getSoundStatus=function(){if(this.initialized)return this.soundEnabled},n.isRewardAvailable=function(){return this.sdk.isRewardAvailable()},n.initialized=!1,n.soundEnabled=!1,n.sdk=null,t.JioIntegration=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},243:function(e,t,n){var o,a=this&&this.__extends||(o=function(e,t){return(o=Object.setPrototypeOf||({__proto__:[]}instanceof Array?function(e,t){e.__proto__=t}:function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}))(e,t)},function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");function n(){this.constructor=e}o(e,t),e.prototype=null===t?Object.create(t):(n.prototype=t.prototype,new n)}),i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}},n=[n,t,n(729)],t=function(e,t,n){"use strict";var o;function r(){var e=o.call(this)||this;return e.initialized=!1,e.language="en",e.isAudioEnabled=!0,e.sdk=null,e.storedData=null,e}Object.defineProperty(t,"__esModule",{value:!0}),t.YoutubePlayable=void 0,n=i(n),o=n.default,a(r,o),r.prototype.init=function(){var t=this;if(this.initialized)return Promise.resolve();try{if(!window.hasOwnProperty("ytgame")||!window.ytgame.IN_PLAYABLES_ENV)return Promise.resolve();this.sdk=window.ytgame,this.isAudioEnabled=this.sdk.system.isAudioEnabled(),this.sdk.game.firstFrameReady(),setTimeout(function(){t.sdk.game.gameReady()},1600);var e=this.sdk.system.getLanguage().then(function(e){t.language=2<e.length?e.slice(0,2):e}).catch(function(){t.language="en"}),n=(this.sdk.system.onAudioEnabledChange(function(e){t.isAudioEnabled=e,t.emit("ytAudioEnabledChange",e)}),this.sdk.system.onPause(function(){t.emit("ytPause")}),this.sdk.system.onResume(function(){t.emit("ytResume")}),this.sdk.game.loadData().then(function(e){try{e&&""!==e&&(t.storedData=JSON.parse(e))}catch(e){t.sdk.health.logError()}}).catch(function(){t.storedData=null}));Promise.all([e,n]).then(function(){return t.initialized=!0,Promise.resolve()}).catch(function(){return Promise.reject()})}catch(e){return Promise.resolve()}},r.prototype.getLanguage=function(){return this.language},r.prototype.addListeners=function(e,t,n,o){this.inPlayablesEnv()&&(this.on("ytPause",function(){e(),n()}),this.on("ytResume",function(){t(),o()}),this.on("ytAudioEnabledChange",function(e){(e?o:n)()}))},r.prototype.inPlayablesEnv=function(){var e=!1;try{e=window.hasOwnProperty("ytgame")&&window.ytgame.IN_PLAYABLES_ENV}catch(e){console.error("Error in inPlayablesEnv:",e)}return e},r.prototype.onSplashRemoved=function(){try{this.inPlayablesEnv()}catch(e){console.error("Error in YT onSplashRemoved:",e)}},r.prototype.getData=function(){var t=this;return this.inPlayablesEnv()?(this.sdk.game.loadData().then(function(e){try{e&&""!==e&&(t.storedData=JSON.parse(e))}catch(e){t.sdk.health.logError()}}).catch(function(){t.storedData=null}),Promise.resolve(this.storedData)):Promise.resolve(null)},r.prototype.setData=function(e){var t=this;if(!this.inPlayablesEnv())return Promise.resolve(null);try{this.inPlayablesEnv()&&this.sdk.game.saveData(JSON.stringify(e)).then(function(){return Promise.resolve({status:"success"})}).catch(function(){t.sdk.health.logError()})}catch(e){this.sdk.health.logError()}return Promise.resolve({status:"failed"})},r.prototype.enableAudioOnStart=function(){return this.isAudioEnabled},r.prototype.sendScoreEvent=function(e){var t=this;try{if(this.inPlayablesEnv())return this.sdk.engagement.sendScore({value:e}).then(function(){return{status:"success"}}).catch(function(){return t.sdk.health.logError(),{status:"failed"}})}catch(e){this.sdk.health.logError()}return Promise.resolve({status:"failed"})},t.YoutubePlayable=r}.apply(t,n);void 0!==t&&(e.exports=t)},393:(e,t,n)=>{n=function(e,t){"use strict";function n(){}Object.defineProperty(t,"__esModule",{value:!0}),t.AzerionSplashLoader=void 0,n.create=function(e,t){return h5branding.SplashLoader.getInstance({gameId:e,gameName:t,gameTitle:t,libs:[],version:"1.0"}).create()},n.removeSplashLoader=function(){return new Promise(function(e,t){h5branding.SplashLoader.getInstance().setButtonCallback(function(){h5branding.SplashLoader.getInstance().destroy(),e(!0)})})},n.onLoadProgress=function(e){h5branding.SplashLoader.getInstance().setLoadProgress(e)},n.onLoadComplete=function(){return h5branding.SplashLoader.getInstance().setLoadProgress(100),new Promise(function(e,t){e(!0)})},t.AzerionSplashLoader=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},812:(e,t,n)=>{n=function(e,t){"use strict";function n(){}Object.defineProperty(t,"__esModule",{value:!0}),t.StorageHandler=void 0,n.getData=function(o){var r=null;return new Promise(function(e,t){try{var n=localStorage.getItem(o);n&&(r=JSON.parse(n))}catch(e){console.log("Could not restore data",e)}e(r)})},n.setData=function(e){var t=e.key,e=e.data,n=!1;try{localStorage.setItem(t,JSON.stringify(e)),n=!0}catch(e){console.log("Could not save data",e)}return Promise.resolve(n)},t.StorageHandler=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)},800:(e,t,n)=>{n=function(e,t){"use strict";function n(){}Object.defineProperty(t,"__esModule",{value:!0}),t.Utils=void 0,n.setAssetPath=function(){var e;null!=(e=window._azerionIntegration)&&e.sa&&(h5branding.Utils.ASSET_LOCATION="assets/")},n.convertToCamelCase=function(e){for(var t=(e=e.toLowerCase()).split(" "),n=0;n<t.length;n++)0!==n&&(t[n]=t[n].charAt(0).toUpperCase()+t[n].substring(1));return t.join("")},t.Utils=n}.apply(t,[n,t]);void 0!==n&&(e.exports=n)}},r={};!function e(t){var n=r[t];return(void 0!==n?n:(n=r[t]={exports:{}},o[t].call(n.exports,n,n.exports,e),n)).exports}(180)})();/******/ (() => { // webpackBootstrap
/******/ 	var __webpack_modules__ = ({
